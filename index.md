...
<style>
  ...
  /* Preliminary results: top-5 eval EER% — highlight entire cell (first block, Eval = column 3). */
  table.radar-results tbody tr:nth-child(1) td:nth-child(3),
  table.radar-results tbody tr:nth-child(2) td:nth-child(3),
  table.radar-results tbody tr:nth-child(3) td:nth-child(3),
  table.radar-results tbody tr:nth-child(7) td:nth-child(3),
  table.radar-results tbody tr:nth-child(10) td:nth-child(3) {
    background-color: rgba(30, 58, 138, 0.22) !important;
    box-shadow: inset 0 0 0 2px rgba(30, 58, 138, 0.42);
  }

  /* Baseline team ID: compact suffix. */
  .team-baseline {
    font-size: 0.72em;
    font-weight: 400;
    margin-left: 0.2em;
...
| **M** | 20.27 | 16.47 | **Z** <span class="team-baseline">(baseline)</span> | 37.71 | 42.60 |  |  |  |
{: .radar-results}
